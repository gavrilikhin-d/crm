...
- Always display times in 24-hour format in the calendar and related UI.
...
- Prefer Telegram UX via command hints, reply-keyboard shortcuts, and inline keyboards over typing raw commands or timezone strings.
